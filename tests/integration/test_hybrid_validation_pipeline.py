...
class TestHybridValidationPipeline:
    ...
    async def test_hybrid_validation_pipeline_full_success(
        ...
        with patch.object(MigrationValidator, 'validate_migration') as mock_static_validation:
            ...
            with patch.object(BehavioralValidationCrew, 'validate_migration') as mock_behavioral_validation:
                ...
                behavioral_request = BehavioralValidationRequest(
                    ...
                    validation_scenarios=["login_flow", "user_registration", "data_validation"]
                )
                ...
                behavioral_findings = [f for f in all_findings if f["validation_source"] == "behavioral"]
    ...
    async def test_hybrid_validation_pipeline_static_only(
        ...
        with patch.object(MigrationValidator, 'validate_migration') as mock_static_validation:
            ...
            assert unified_report["fidelity_assessment"]["unified_score"] == sample_static_result.fidelity_score
    ...
    async def test_hybrid_validation_pipeline_behavioral_only(
        ...
        with patch.object(BehavioralValidationCrew, 'validate_migration') as mock_behavioral_validation:
            ...
            assert unified_report["fidelity_assessment"]["unified_score"] == sample_behavioral_result.fidelity_score
    ...
    async def test_hybrid_validation_pipeline_performance_tracking(
        ...
        with patch.object(MigrationValidator, 'validate_migration') as mock_static_validation:
            ...
            with patch.object(BehavioralValidationCrew, 'validate_migration') as mock_behavioral_validation:
                ...
                assert performance_metrics["static_execution_time"] == sample_static_result.execution_time
                assert performance_metrics["behavioral_execution_time"] == sample_behavioral_result.execution_time
                assert performance_metrics["total_execution_time"] > 0

                # Verify total pipeline execution was tracked
                expected_total = sample_static_result.execution_time + sample_behavioral_result.execution_time
    ...
    async def test_hybrid_validation_pipeline_error_recovery(
        ...
        with patch.object(MigrationValidator, 'validate_migration') as mock_static_validation:
            mock_static_validation.side_effect = Exception("Static validation infrastructure failure")

            with patch.object(BehavioralValidationCrew, 'validate_migration') as mock_behavioral_validation:
                mock_behavioral_validation.side_effect = Exception("Behavioral validation infrastructure failure")
                ...
                assert any("infrastructure" in action["description"].lower() for action in immediate_actions)