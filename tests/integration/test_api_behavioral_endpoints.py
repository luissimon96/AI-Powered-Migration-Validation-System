...
class TestBehavioralValidationAPIEndpoints:
    ...
    def test_get_behavioral_validation_status_pending(self, client):
        ...
        with patch('src.api.routes.behavioral_validation_sessions', {
            ...
            assert response_data["progress"] == "Behavioral validation queued for processing"
    ...
    def test_get_behavioral_validation_status_processing(self, client):
        ...
        with patch('src.api.routes.behavioral_validation_sessions', {
            ...
            assert response_data["progress"] == "Executing behavioral validation scenarios"
...
class TestBehavioralValidationBackgroundTasks:
    ...
    def mock_behavioral_crew(self):
        ...
        with patch('src.api.routes.create_behavioral_validation_crew') as mock_crew_factory:
            mock_crew = AsyncMock()
    ...
    def test_background_task_successful_execution(
        ...
        mock_behavioral_crew.validate_migration.return_value = mock_successful_behavioral_result
        ...
        with patch('src.api.routes.behavioral_validation_sessions', {}) as mock_sessions:
            # Initialize session
    ...
    def test_background_task_error_handling(self, mock_behavioral_crew):
        ...
        mock_behavioral_crew.validate_migration.side_effect = Exception("Validation infrastructure failure")
