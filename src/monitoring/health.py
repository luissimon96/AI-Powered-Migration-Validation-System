...
class SystemHealthMonitor:
    ...
    async def _check_redis_connectivity(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Redis connectivity failed: {str(e)}")
    ...
    async def _check_llm_service_availability(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"LLM service check failed: {str(e)}")
    ...
    async def _check_celery_workers(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Celery workers check failed: {str(e)}")
    ...
    async def _check_file_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"File system check failed: {str(e)}")
    ...
    async def _check_configuration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Configuration check failed: {str(e)}")
