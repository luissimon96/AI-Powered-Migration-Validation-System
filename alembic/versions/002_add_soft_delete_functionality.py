...
def upgrade() -> None:
    ...
    op.add_column(
        "validation_sessions", sa.Column("deleted_by", sa.String(255), nullable=True)
    )
    op.add_column(
        "validation_sessions", sa.Column("deletion_reason", sa.Text(), nullable=True)
    )
    op.add_column(
        "validation_sessions",
    ...
    op.add_column(
        "validation_results", sa.Column("deleted_by", sa.String(255), nullable=True)
    )
    op.add_column(
        "validation_results", sa.Column("deletion_reason", sa.Text(), nullable=True)
    )
    op.add_column(
        "validation_results",
        sa.Column("is_deleted", sa.Boolean(), nullable=False, server_default="false"),
    ...
    op.add_column(
        "validation_metrics", sa.Column("deleted_by", sa.String(255), nullable=True)
    )
    op.add_column(
        "validation_metrics", sa.Column("deletion_reason", sa.Text(), nullable=True)
    )
    op.add_column(
        "validation_metrics",
        sa.Column("is_deleted", sa.Boolean(), nullable=False, server_default="false"),
...
def downgrade() -> None:
    ...
    # Drop indexes first
    op.drop_index(
        op.f("ix_validation_metrics_deleted_at"), table_name="validation_metrics"
    )
    op.drop_index(
        op.f("ix_validation_metrics_is_deleted"), table_name="validation_metrics"
    )
    op.drop_index(
        op.f("ix_behavioral_test_results_deleted_at"),
    ...
    op.drop_index(
        op.f("ix_validation_results_deleted_at"), table_name="validation_results"
    )
    op.drop_index(
        op.f("ix_validation_results_is_deleted"), table_name="validation_results"
    )
    op.drop_index(
        op.f("ix_validation_sessions_deleted_at"), table_name="validation_sessions"
    )
    op.drop_index(
        op.f("ix_validation_sessions_is_deleted"), table_name="validation_sessions"
    )
