...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            'id',
            name=op.f('pk_validation_sessions')),
        sa.UniqueConstraint(
            'request_id',
            name=op.f('uq_validation_sessions_request_id')))
    ...
    op.create_index(
        ...
        unique=False)
    op.create_index(
        'ix_validation_sessions_status',
        'validation_sessions',
        ['status'],
        unique=False)
    op.create_index(
        'ix_validation_sessions_status_created', 'validation_sessions', [
            'status', 'created_at'], unique=False)
    op.create_index('ix_validation_sessions_technologies', 'validation_sessions', [
                    'source_technology', 'target_technology'], unique=False)
    op.create_index(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            'id',
            name=op.f('pk_validation_results')))
    ...
    op.create_index(
        ...
        ['session_id'],
        unique=False)
    op.create_index('ix_validation_results_status_score', 'validation_results', [
                    'overall_status', 'fidelity_score'], unique=False)
    op.create_index('ix_validation_results_type_created', 'validation_results', [
                    'result_type', 'created_at'], unique=False)
    op.create_index(
    ...
    op.create_index('ix_discrepancies_component_resolved', 'validation_discrepancies', [
                    'component_type', 'is_resolved'], unique=False)
    op.create_index(
        'ix_discrepancies_confidence',
        'validation_discrepancies',
        ['confidence'],
        unique=False)
    op.create_index('ix_discrepancies_severity_type', 'validation_discrepancies', [
                    'severity', 'discrepancy_type'], unique=False)
    op.create_index(
    ...
    op.create_index('ix_metrics_date_period', 'validation_metrics',
                    ['metric_date', 'metric_period'], unique=False)
    op.create_index(
    ...
    op.create_index(
        ...
        unique=False)
    op.create_index(
        'ix_behavioral_tests_session_created', 'behavioral_test_results', [
            'session_id', 'created_at'], unique=False)
    op.create_index('ix_behavioral_tests_status_scenario', 'behavioral_test_results', [
                    'execution_status', 'scenario_name'], unique=False)
